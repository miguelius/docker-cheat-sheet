...
**¿Querés mejorar este machete? ¡Mirá la sección [Contribuciones](#contributing)!**
...
* [Images](#images)
* [Networks](#networks)
* [Registry y Repository](#registry--repository)
...
Así es como se contribuye a este machete.

### Abrir el README.md

Click [README.md](https://github.com/wsargent/docker-cheat-sheet/blob/master/README.md) <-- this link

![Apretá acá](../images/click.png)

### Editar la página

![Edita esto](../images/edit.png)

### Hacer los cambios y commitear

![Cambia esto](../images/change.png)

![Commitea](../images/commit.png)
